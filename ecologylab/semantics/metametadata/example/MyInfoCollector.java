 ...
 * 
 */
public class MyInfoCollector<C extends MyContainer> implements InfoCollector<C>
{
	...
	private ArrayList<C.MetadataCollectingListener>	collectingListeners;
	 ...
	 */
	public void addListener(C.MetadataCollectingListener listener)
	{
	 ...
	 */
	public void removeListener(C.MetadataCollectingListener listener)
	{
	 ...
	 */
	public ArrayList<C.MetadataCollectingListener> getListeners()
	{
		return collectingListeners;
	}

	/**
	 * When you use only metadata defined by the library by default, you should use this constructor.
	 * 
	 * @param repositoryDir
	 *          The directory containing your meta-metadata repository .XML files.
	 */
	public MyInfoCollector(String repositoryDir)
	{
		this(repositoryDir, GeneratedMetadataTranslationScope.get());
	}

	// load repository file and stuff
	/**
	 * This constructor is used when you write your own metadata structures in the .XML files.
	 * Remember to compile them with MetadataCompiler first, and if you have your own Semantic
	 * Actions, you should include them in the corresponding translation scope(s) when compiling.
	 * 
	 * @param repositoryDir
	 *          The directory containing your meta-metadata repository .XML files.
	 * @param metadataTScope
	 *          The Translation Scope of generated semantics. You should use
	 *          GeneratedMetadataTranslationScope.get() to get this translation scope, where the
	 *          GeneratedMetadataTranslationScope is generated by the MetadataCompiler.
	 */
	 ...
	 */
	@Override
	public Container getContainer(C ancestor, ParsedURL purl, boolean reincarnate,
			boolean addToCandidatesIfNeeded, MetaMetadata metaMetadata)
	{
		if (!accept(purl))
			return null;

		// here, we construct a semantic action handler for each new container
		// as a "context" for that container
		MyContainer result = new MyContainer(ancestor, this, new SemanticActionHandlerBase(), purl);
	 ...
	 */
	@Override
	public Container getContainerDownloadIfNeeded(C ancestor, ParsedURL purl, Seed seed, boolean dnd,
			boolean justCrawl, boolean justMedia)
	{
		Container result = getContainer(ancestor, purl, false, false, null);
		downloadMonitor.download(result, null);
		return result;
	}

	@Override
	public C getContainerForSearch(MyContainer ancestor, ParsedURL purl, Seed seed)
	{
		// TODO Auto-generated method stub
		return null;
	}
