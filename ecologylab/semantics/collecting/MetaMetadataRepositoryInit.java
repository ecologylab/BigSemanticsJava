...
//			METAMETADATA_REPOSITORY_DIR_FILE 	= new File("../ecologylabSemantics/repository");
		...
		DOCUMENT_META_METADATA						= META_METADATA_REPOSITORY.getByName(DOCUMENT_TAG);
		PDF_META_METADATA									= META_METADATA_REPOSITORY.getByName(PDF_TAG);
		SEARCH_META_METADATA							= META_METADATA_REPOSITORY.getByName(SEARCH_TAG);
		IMAGE_META_METADATA								= META_METADATA_REPOSITORY.getByName(IMAGE_TAG);
		DEBUG_META_METADATA								= META_METADATA_REPOSITORY.getByName(DEBUG_TAG);
		IMAGE_CLIPPING_META_METADATA			= META_METADATA_REPOSITORY.getByName(IMAGE_CLIPPING_TAG);
	}
