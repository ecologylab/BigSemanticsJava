...
subprojects = [
		("ecologylabSemantics", "bigSemanticsCore"),
		("cyberneko", "cyberneko"),
		("ecologylabSemanticsCyberneko", "bigSemanticsCybernekoWrapper"),
		("metadataExtractor", "imageMetadataExtractor"),
		("ecologylabSemanticsSun", "bigSemanticsSunSpecifics"),
		("ecologylabSemanticsAndroid", "bigSemanticsAndroidSpecifics"),
		("ecologylabSemanticsExample", "bigSemanticsSDK"),
]
